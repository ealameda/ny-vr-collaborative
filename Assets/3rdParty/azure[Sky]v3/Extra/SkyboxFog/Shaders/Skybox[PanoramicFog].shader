Shader "azure[Sky]/Custom/Panoramic Fog"
{
	Properties
	{
		_SkyRotate("Rotation Angle", Range(0,360)) = 0
		[NoScaleOffset] _SkyTex("Panoramic Sky Texture", 2D) = "white" {}
...
//			   return float4(depth*20,depth*20,depth*20,1.0); // To see the depth
